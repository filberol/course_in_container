...
на печати evidence и повторном прогоне на защите (см. evidence/collect.sh),
а не на скрытности параметров. Открытость нужна, чтобы студент мог сам
пересчитать и проверить свой вариант.
